...
four or more types. Non-attractiveness fails from four types (the equiprobable family); uniqueness fails
from five types, by an explicit rational operator with two fixed points, and a six-type operator has a
whole segment of fixed points. Uniqueness at four types is left open.
